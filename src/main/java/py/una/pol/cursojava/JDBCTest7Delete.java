...
public class JDBCTest7Delete {

	private static final Logger logger = LogManager.getLogger(JDBCTest7Delete.class);
	...
	public static void main(String[] args) {
		...
		try {
			...
			PreparedStatement preparedStatement = conexion.prepareStatement("DELETE FROM personas WHERE id=?");
